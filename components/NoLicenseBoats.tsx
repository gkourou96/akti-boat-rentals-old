...
export default function NoLicenseBoats() {
  return (
    <>
      ...
      */}
      <section
        className={`relative w-full h-auto lg:h-195.75 bg-[#F4F8FA] overflow-hidden flex flex-col justify-center ${ubuntu.variable} ${openSans.variable}`}
      >
        {/* Background Texture */}
        ...
        */}
        <div className="relative z-10 w-full max-w-360 mx-auto px-6 lg:px-16 xl:px-24 h-full flex flex-col gap-12 lg:gap-0 lg:justify-between py-16 lg:py-12">
          {/* --- HEADER --- */}
          ...
          {/* --- BOATS CAROUSEL --- */}
          <div className="flex w-full gap-8 overflow-x-auto pb-8 hide-scrollbar snap-x snap-mandatory items-center h-105">
            {boats.map((boat, index) => (
              <div
                key={index}
                // FIXED CARD WIDTH: 282px
                className="group relative h-100 w-70.5 min-w-70.5 shrink-0 overflow-hidden rounded-[20px] bg-white cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-700 ease-[0.23,1,0.32,1] snap-center"
              >
                ...
                {/* 2. Overlays */}
                <div className="absolute inset-0 bg-linear-to-t from-[#0D4168] via-transparent to-transparent opacity-60 transition-opacity duration-500 group-hover:opacity-40" />
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-end p-6">
                  ...
                  <div className="relative translate-y-12.5 group-hover:translate-y-0 transition-transform duration-500 ease-[0.23,1,0.32,1]">
                    {/* Title */}
                    ...
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-75">
                      <button className="w-full h-10 flex items-center justify-center gap-2 rounded-full bg-white text-[#0D4168]shadow-xl">
