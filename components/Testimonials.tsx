...
export default function Testimonials() {
  return (
    <section className="mx-auto w-full h-auto py-16 xl:py-0 xl:h-147 max-w-360 bg-[linear-gradient(0deg,#FFFFFF,#FFFFFF),linear-gradient(0deg,rgba(242,234,214,0.5),rgba(242,234,214,0.5))] xl:pt-22 overflow-hidden">
      {/* 1. TITLE CONTAINER */}
